...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    public alertCtrl: AlertController, public authHandler:AuthHandlerProvider, public loadingCtrl: LoadingController,public mywardprovider: MyWardDataProvider) {
    ...
    this.authHandler.setLoginFailureCallback((error) => {
      this.loader.dismiss();
      if (error !== null) {
        this.mywardprovider.showAlert('Login Failure', error);
      } else {
        this.mywardprovider.showAlert('Login Failure', 'Failed to login.');
      }
    });
  ...
  processForm() {
    ...
    if (username === "" || password === "") {
      this.mywardprovider.showAlert('Login Failure', 'Username and password are required');
      return;
    }
